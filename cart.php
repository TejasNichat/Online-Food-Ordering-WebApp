...
<?php
  echo '<a href="cart.php?action=empty"><button class="btn btn-danger"><span class="glyphicon glyphicon-trash"></span> Empty Cart</button></a>&nbsp;<a href="ordernow.php"><button class="btn btn-warning">Continue Shopping</button></a>&nbsp;<a href="payment.php"><button class="btn btn-success pull-right"><span class="glyphicon glyphicon-share-alt"></span> Check Out</button></a>';
?>
</div>
...
if(empty($_SESSION["cart"]))
{
  ...
  <div class="container">
      <div class="jumbotron">
        ...
        <p>Oops! We can't smell any food here. Go back and <a href="ordernow.php">order now.</a></p>
